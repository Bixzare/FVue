...
more = st.button("More info about Columns")

if more:
    st.write("""
Roa(C) Before Interest And Depreciation Before Interest: This column likely represents the Return on Assets (ROA) before interest and depreciation. Users should input numerical values representing the ROA, typically expressed as a percentage.

Roa(A) Before Interest And % After Tax: This column represents Return on Assets (ROA) before interest and after tax. Users should input numerical values representing the ROA, typically expressed as a percentage.

Roa(B) Before Interest And Depreciation After Tax: This column represents Return on Assets (ROA) before interest and depreciation but after tax. Users should input numerical values representing the ROA, typically expressed as a percentage.

Operating Gross Margin: This column represents the operating gross margin, typically expressed as a percentage. Users should input numerical values representing the operating gross margin.

Realized Sales Gross Margin: This column represents the gross margin on realized sales, typically expressed as a percentage. Users should input numerical values representing the realized sales gross margin.

Cash Flow Rate: This column represents the cash flow rate, typically expressed as a percentage. Users should input numerical values representing the cash flow rate.

Tax Rate (A): This column represents the tax rate, typically expressed as a percentage. Users should input numerical values representing the tax rate.

Net Value Per Share (B): This column represents the net value per share. Users should input numerical values representing the net value per share.

Net Value Per Share (A): This column represents the net value per share. Users should input numerical values representing the net value per share.

Net Value Per Share (C): This column represents the net value per share. Users should input numerical values representing the net value per share.

Persistent Eps In The Last Four Seasons: This column represents the persistent earnings per share (EPS) in the last four seasons. Users should input numerical values representing the EPS.

Cash Flow Per Share: This column represents the cash flow per share. Users should input numerical values representing the cash flow per share.

Operating Profit Per Share (Yuan ¥): This column represents the operating profit per share in Yuan. Users should input numerical values representing the operating profit per share.

Per Share Net Profit Before Tax (Yuan ¥): This column represents the net profit before tax per share in Yuan. Users should input numerical values representing the net profit per share.

Net Value Growth Rate: This column represents the growth rate of net value. Users should input numerical values representing the growth rate.

Cash Reinvestment %: This column represents the cash reinvestment percentage. Users should input numerical values representing the cash reinvestment percentage.

Debt Ratio %: This column represents the debt ratio percentage. Users should input numerical values representing the debt ratio percentage.

Net Worth/Assets: This column represents the ratio of net worth to assets. Users should input numerical values representing the ratio.

Borrowing Dependency: This column represents the borrowing dependency. Users should input numerical values representing the borrowing dependency.

Contingent Liabilities/Net Worth: This column represents the ratio of contingent liabilities to net worth. Users should input numerical values representing the ratio.

Operating Profit/Paid-In Capital: This column represents the ratio of operating profit to paid-in capital. Users should input numerical values representing the ratio.

Net Profit Before Tax/Paid-In Capital: This column represents the ratio of net profit before tax to paid-in capital. Users should input numerical values representing the ratio.

Inventory And Accounts Receivable/Net Value: This column represents the ratio of inventory and accounts receivable to net value. Users should input numerical values representing the ratio.

Total Asset Turnover: This column represents the total asset turnover. Users should input numerical values representing the turnover rate.

Fixed Assets Turnover Frequency: This column represents the fixed assets turnover frequency. Users should input numerical values representing the frequency.

Operating Profit Per Person: This column represents the operating profit per person. Users should input numerical values representing the profit per person.
             
employment_status: Categorical value representing the status of employment (e.g., employed, unemployed, self-employed).

housing_status: Categorical value representing the housing status of the customer (e.g., own, rent, mortgage).

payment_type: Categorical value representing the type of payment used (e.g., credit card, debit card, bank transfer).

device_os: Categorical value representing the operating system of the device used by the customer (e.g., iOS, Android, Windows).

source: Categorical value representing the source of the transaction or request (e.g., website, mobile app, in-store).           
